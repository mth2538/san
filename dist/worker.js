...
var uuid = "30d21b15-8b26-4ea5-ba8f-904ef6074526";
var sha224EncodePassword = "abcf0a23e0d54a719543f3d24d797c0fe8adf926c98019c675655b7f";
var systemSig = "1a2b3c4d5e6f7g8h9i0j";
var pathSig = "";
var rootDomain = "";
var serviceName = getBeforeDot(rootDomain);
var cfApiTokens = "";
var apiEmail = "";
var accountID = "";
var zoneID = "";
var subPassword = "";
var subpwd = "";
var defaultDocDomain = "example.com";
var isApiReady = false;
var proxyIP = "";
var cachedProxyList = [];
var APP_DOMAIN = `${rootDomain}`;
var PORTS = [443, 80];
        ...
        for (const protocol of PROTOCOLS) {
          if (protocol === "ss") {
            ...
            uri.searchParams.set(
              "plugin",
              `v2ray-plugin${port == 80 ? "" : ";tls"};mux=0;mode=websocket;path=/${proxyIP2}-${proxyPort}/${systemSig};host=${hostName}`
            );
          } else {
            uri.username = uuid;
            ...
            for (const port of filterPort) {
              for (const protocol of filterVPN) {
                ...
                if (protocol == "ss") {
                  ...
                  uri.searchParams.set(
                    "plugin",
                    `v2ray-plugin${port == 80 ? "" : ";tls"};mux=0;mode=websocket;path=/${proxy.proxyIP}-${proxy.proxyPort}/${systemSig};host=${APP_DOMAIN}`
                    // 添加skcoswodahS的访问权限
                  );
                } else {
                  uri.username = uuid;
...
PLACEHOLDER_INFO`);
  ...
  buildCountryFlag() {
    ...
    for (const flag of new Set(flagList)) {
      flagElement += `<a href="/sub?pwd=${subpwd}&cc=${flag}${proxyBankUrl ? "&proxy-list=" + proxyBankUrl : ""}" class="py-1" ><img width=20 src="https://hatscripts.github.io/circle-flags/flags/${flag.toLowerCase()}.svg" /></a>`;
    }
...
__name(getBeforeDot, "getBeforeDot");
